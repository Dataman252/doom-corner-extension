...
2. Extract the downloaded ZIP folder to somewhere safe on your computer.
3. Open Google Chrome and type `chrome://extensions/` into the URL bar.
4. Turn on **Developer mode** (the toggle in the top right corner).
5. Click the **Load unpacked** button in the top left.
6. Select the extracted folder. 

*Boom. You're done. Pin the extension icon to your browser, click "Select ROM folder" to point it to your game library, and press Play!*
